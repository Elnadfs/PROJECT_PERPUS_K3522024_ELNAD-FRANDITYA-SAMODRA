...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard ELPerpus</div>
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary">
  <a href="https://www.instagram.com/elnaddfs/" target="_blank" class="text-primary text-decoration-none">Elnad Franditya S</a>
</span> © 2024</p>
      <p class="mt-2">Tugas PemWeb</p>
      </div>
    </footer>
